...
function isn_register_post_types()
{
    ...
    register_post_type('book', [
        ...
        'public' => true,
        'description' => __('Ici sont repris tous les livres', 'isn'),
        'show_ui' => true,
        'show_in_menu' => true,
        'query_var' => true,
        'has_archive' => true,
    ...
    register_post_type('exhibition', [
        'label' => 'Expositions',
        'labels' => [
            'singular_name' => __('Exposition', 'isn'),
            'menu_name' => _x('Expositions', 'Admin Menu text', 'isn'),
            'name_admin_bar' => _x('Expositions', 'Add New on Toolbar', 'isn'),
            'add_new' => __('Ajouter une nouvelle exposition', 'isn'),
            'add_new_item' => __('Ajouter une exposition', 'isn'),
            'new_item' => __('Nouvelle exposition', 'isn'),
            'edit_item' => __('Éditer l’exposition', 'isn'),
            'view_item' => __('Voir l’esposition', 'isn'),
            'all_items' => __('Toutes les expositions', 'isn'),
            'search_items' => __('Rechercher une exposition', 'isn'),
            'parent_item_colon' => __('Exposition parent:', 'isn'),
            'not_found' => __('Pas d’exposition trouvé.', 'isn'),
            'not_found_in_trash' => __('Pas d’exposition trouvé dans la corbeille.', 'isn'),
            'featured_image' => _x('L’image de couverture de l’exposition', 'Overrides the “Featured Image” phrase for this post type. Added in 4.3', 'isn'),
            'set_featured_image' => _x('Ajouter une image de couverture', 'Overrides the “Set featured image” phrase for this post type. Added in 4.3', 'isn'),
            'remove_featured_image' => _x('Supprimer l’image de couverture', 'Overrides the “Remove featured image” phrase for this post type. Added in 4.3', 'isn'),
            'use_featured_image' => _x('Utiliser une image de couverture', 'Overrides the “Use as featured image” phrase for this post type. Added in 4.3', 'isn'),
            'archives' => _x('Archive des expositions', 'The post type archive label used in nav menus. Default “Post Archives”. Added in 4.4', 'isn'),
            'insert_into_item' => _x('Ajouter dans l’exposition', 'Overrides the “Insert into post”/”Insert into page” phrase (used when inserting media into a post). Added in 4.4', 'isn'),
            'uploaded_to_this_item' => _x('Téléverser vers la fiche de cette exposition', 'Overrides the “Uploaded to this post”/”Uploaded to this page” phrase (used when viewing media attached to a post). Added in 4.4', 'isn'),
            'filter_items_list' => _x('Filtrer la liste des expositions', 'Screen reader text for the filter links heading on the post type listing screen. Default “Filter posts list”/”Filter pages list”. Added in 4.4', 'isn'),
            'items_list_navigation' => _x('Navigation de la liste des expositions', 'Screen reader text for the pagination heading on the post type listing screen. Default “Posts list navigation”/”Pages list navigation”. Added in 4.4', 'isn'),
            'items_list' => _x('Liste des expositions', 'Screen reader text for the items list heading on the post type listing screen. Default “Posts list”/”Pages list”. Added in 4.4', 'isn'),
        ],
        'taxonomies' => array('category', 'post_tag'),
        'public' => true,
        'description' => __('Ici sont repris toutes les expositions', 'isn'),
