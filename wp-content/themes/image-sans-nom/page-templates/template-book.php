...
<?php if (have_posts()): while ($loop->have_posts()): $loop->the_post(); ?>
    <article class="books" aria-labelledby="books-heading">
        <div class="books__header">
            ...
            <span class="books__author"><?php the_field("author"); ?></span>
            <a href="<?php the_permalink(); ?>" class="books__link btn">Découvrir le livre <span
...
<?php endwhile; endif; ?>
    <div class="pagination-links">
        <?= paginate_links([
            'format' => '?pagination=%#%',
            'current' => get_query_var('pagination') ?: 1,
