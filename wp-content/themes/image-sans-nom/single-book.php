...
<?php if (have_posts()): while (have_posts()): the_post(); ?>
    <article class="book" aria-labelledby="book-heading" itemscope itemtype="https://schema.org/Book">
        <div class="book__header">
            <h2 class="book__heading" id="book-heading" role="heading" aria-level="2"
                itemprop="name"><?= the_title(); ?></h2>
